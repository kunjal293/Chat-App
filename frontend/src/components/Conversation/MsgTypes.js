...
import { Menu,MenuItem,Box, Divider,IconButton, Link, Stack, Typography } from "@mui/material";
        ...
        <Stack spacing={2}>
            <Stack p={2} spacing={3} alignItems="center" sx={{backgroundColor:theme.palette.background.paper,borderRadius:1}}>
             ...
             <Stack spacing={2}>
                ...
                <Typography varient="subtitle2"sx={{color:theme.palette.primary.main}} component={Link}
  ...
  return (
    <Stack direction="row" justifyContent={el.incoming ? "start" : "end"}>
      ...
      >
        <Typography
          variant="body2"
          color={el.incoming ? theme.palette.test : "#fff"}
        >
          {el.message}
        </Typography>
      </Box>
...
export {DocMsg,MessageOptions, LinkMsg,Timeline, TextMsg, MediaMsg, ReplyMsg };
